...
![Licença](https://img.shields.io/github/license/sr00t3d/bat-consistency-checker) ![Script Bat](https://img.shields.io/badge/language-Bash-green.svg)
...
1.  Baixe o arquivo do script (ex.: `dns-checker.bat`).
...
👉 [**Verifique seu Domínio e DNS Rapidamente**](https://perciocastelo.com.br/blog/check-your-domain-and-dns-quickly-in-cmd.html)
